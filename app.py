...
st.sidebar.markdown(
    f'<img src="data:image/gif;base64,{data_url}" alt="" style="height:250px; width:300px;">',
...
st.sidebar.info(
        ...
        [Sai Mounika Balla][#linkedin]
        
        [#linkedin]: https://www.linkedin.com/in/ballasaimounika/
        [#streamlit-app]: https://github.com/ballasaimounika/YouTube-Summarizer/
